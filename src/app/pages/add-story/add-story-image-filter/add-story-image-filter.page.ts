...
@Component({
  selector: 'app-add-story-image-filter',
  templateUrl: './add-story-image-filter.page.html',
  styleUrls: ['./add-story-image-filter.page.scss'],
})
export class AddStoryImageFilterPage implements OnInit {
